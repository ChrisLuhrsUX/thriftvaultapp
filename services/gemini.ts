...
// Large-silhouette handmade dresses (kaftan, abaya, butterfly abaya, batwing/dolman maxi,
// floor-length gown). These take 3-5 yards of fabric and read as moderate-tier even when
// the construction is "plain knit" with no fitted bodice or lace trim. Without a floor
// the model drops to SIMPLE $30-$70 because "plain stretchy knit" surface-matches the
// prompt's "plain crochet/knit slip" Simple example. A slip is ~1.5 yds; a kaftan is ~4
// yds, the labor floor is 2-3x higher. Real Depop sold comps for unknown-maker handmade
// butterfly abayas / batwing maxis cluster $50-$95 in stretch satin jersey.
const HANDMADE_LARGE_DRESS_RX = /\b(kaftans?|caftans?|abayas?|butterfly\s+abaya|batwing|dolman[\s-]*(dress|maxi|gown)|maxi\s+dress|floor[\s-]?length\s+(dress|gown|kaftan|caftan|abaya))\b/i;
...
- PRICING, mentally benchmark against comparable recently-sold listings on Depop, Poshmark, eBay, and Etsy before setting any price. Do not default to the low end of a range, price for what the item actually sells for in current market.
  ...
  ► IF isCustom = true → HANDMADE PRICING (use this path; ignore all factory brand tiers below). Price by FINISHED LOOK that an unknown maker actually sells for on Depop/Etsy/Poshmark. Do NOT use a labor-hour formula, unknown makers cannot command labor-rate pricing in a saturated handmade market, and labor math consistently overshoots actual sold comps by 30–80%. Default assumption is unknown maker; named established Etsy/Depop creators with documented sale history may exceed unknown-maker ceilings only when the creator name is explicitly visible/known.
    ...
    HANDMADE DRESS EXCEPTION, non-denim, non-altered handmade dresses (category = "dresses" AND from-scratch, not altered factory base). Tier by SILHOUETTE + FABRIC YARDAGE, not just construction complexity. A kaftan and a slip dress are NOT the same labor floor even when both read as "plain knit". Simple is reserved for SMALL dresses with low yardage (~1.5–2.5 yds, body-skimming, mini or short-length): plain crochet/knit slip, basic sewn shift, plain mini straight-cut $30–$70. Moderate covers MID-SIZE or DRAMATIC silhouettes (~3–5 yds, intentional drape, dramatic sleeves, midi-to-maxi length, or fitted-with-detail construction): cottagecore midi, fitted construction, lace trim, bias-cut sewn, kaftan, caftan, abaya, butterfly abaya, batwing/dolman maxi, A-line midi $50–$120. Complex covers LARGE-FORMAT or ELABORATE construction (~5+ yds, multi-panel, structured interior, or fully-finished lining): full-skirt crochet maxi, multi-panel sewn gown, smocked or boned construction, lined floor-length gown $90–$200. Hard ceiling $200 unless named established maker. WORKED EXAMPLE: floor-length stretch-satin kaftan with batwing/dolman sleeves and plain round neckline = MODERATE tier (large yardage + dramatic silhouette overrides the "plain knit" simple-tier framing); anchor lower-middle ~$65–$85 per FIRST-PASS ANCHORING (band low + 30% of width = $50 + $21 = $71), reserve $100+ only for explicit upper-tier signals (visible lining, named maker, premium fabric named like silk charmeuse).
  ...
  ► IF category = "furniture" → FURNITURE PRICING (use this path; IGNORE the clothing factory tiers and handmade labor formulas above, furniture has its own market dynamics):
    ...
    TABLE TYPE DISAMBIGUATION, HARD RULE: when the item is a table, route by visible HEIGHT + SURFACE proportions + ROOM CONTEXT before assigning name and price tier. Tables of different forms span 10x price differences (mass-market end table $20 vs MCM authenticated coffee table $2000), so misclassification is the most expensive failure mode in this category. Do NOT default to "dining table" when the type is ambiguous; default to the LOWER band (side/end or coffee) with confidence: low. All bands below anchor to the platforms named at the top of FURNITURE PRICING (Facebook Marketplace, Chairish, 1stDibs, Craigslist, eBay, AptDeco) plus OfferUp for casual local and Etsy for vintage-only smalls under 30 lbs. No invented platforms.

      Coffee table: height 16–20" (modern coffee tables sit 18–20" because sofa seat heights have risen). Surface 36–54" long × 18–24" deep. In-front-of-sofa context, glass top or low wood slab, hairpin / cross-stretcher / pedestal base. Shippable smalls (under 50 lbs disassembled), eBay is in the comp pool.
        • Contemporary (West Elm, CB2, Article, Joybird): $40–$200. Anchor Facebook Marketplace + AptDeco.
        • MCM authenticated (Noguchi IN-50, Nakashima Minguren, Platner, Saarinen Tulip 36"-round coffee variant; these iconic coffee silhouettes are the headline pieces of the era, NOT a discount tier vs dining): $400–$3000+. Anchor Chairish + 1stDibs primary; eBay sold-comps trail 20–40%.
        • Vintage Danish/Scandinavian unbranded (teak, rosewood, walnut, sleek tapered legs): $200–$700. Anchor Chairish + Facebook Marketplace.
        • Vintage American mid-tier (Heywood-Wakefield, Lane Acclaim, Bassett Artisan, Broyhill Brasilia coffee variant): $80–$400. Anchor Facebook Marketplace + eBay.
        • Modern mass-market particleboard (IKEA, Wayfair budget, Target Threshold): $15–$60. Anchor OfferUp + Craigslist + Facebook Marketplace local-pickup.

      End / side / chairside / accent table: height 22–28" (clamp at 28" max to avoid overlap with console). Surface ≤28" × 28", beside seating or bed, single drawer or open shelf common. Shippable smalls under 30 lbs, full eBay/Etsy comp pool.
        • Modern mass-market $15–$50. Anchor OfferUp + Craigslist + Facebook Marketplace.
        • Vintage solid wood $40–$200. Anchor Facebook Marketplace + eBay + Etsy.
        • MCM authenticated $150–$600. Anchor Chairish + 1stDibs + eBay.

      Nightstand: height 22–28", bedroom context, typically drawer-fronted. Same dimensional band as end tables; bed-adjacency routes here. Same per-tier pricing and platform anchors as end/side bands above.

      Console / sofa table: height 28–32", NARROW depth 12–16" (the routing key: a 28–32" tall table with 24"+ depth is dining, not console), length 48–72", behind-sofa or against-wall context, often two-tier or drawer-fronted. Borderline shippability (48"+ long pieces are usually local-pickup).
        • Contemporary $80–$300. Anchor Facebook Marketplace + AptDeco.
        • MCM / vintage $200–$800. Anchor Chairish + Facebook Marketplace.

      Dining table: height 28–30", surface ≥36" × ≥60" (or ≥48" diameter for round), seats 4+, trestle / pedestal / four-leg base, no drawer fronts, no living-room context. Local-pickup-only (60"+ surface, 80+ lbs assembled); eBay drops out of the comp pool. Use the existing BRAND/ERA TIERS ladder above ($150–$600 Modern contemporary, $200–$900 Vintage Danish/Scandinavian, $100–$800 Vintage American mid-tier, $400–$8000+ MCM authenticated). Platform anchors: contemporary + Vintage American mid-tier → Facebook Marketplace + Craigslist + AptDeco; MCM authenticated + Vintage Danish/Scandinavian unbranded → Chairish + 1stDibs (premium curated, prices skew 30–50% higher than Facebook Marketplace).

      Counter-height table: height 34–36", paired with counter stools. Contemporary $80–$250. Anchor Facebook Marketplace + AptDeco.

      Bar-height table: height 40–42", paired with bar stools. Contemporary $100–$300. Anchor Facebook Marketplace + AptDeco.
...
- RED FLAG DETECTION, HARD RULE, populate redFlags (1–2 items) when ANY of the following are true. This is NOT optional, if ANY condition matches, you MUST include at least one redFlag. Empty array [] ONLY when zero conditions match.
  ...
  MCM KNOCKOFF: the silhouette resembles a famous MCM or named-designer chair (Eames Shell, Wegner Wishbone, Saarinen Tulip table or chair, Barcelona Chair, Eames Lounge + Ottoman, Wegner Papa Bear, Knoll Womb, Jacobsen Egg, Jacobsen Swan, Eames Aluminum Group / Soft Pad Management Chair, Pollock Executive, Herman Miller Aeron, Bertoia Side Chair, Emeco 1006 Navy Chair) but no maker label, sticker, or stamp is visible in the photo. → Flag: "Verify maker stamp or label for the relevant chair form before paying authenticated prices; for MCM lounges and dining (Eames Lounge, Wegner Wishbone, Saarinen Tulip Chair, Womb, Egg, Swan, Barcelona) check underside of seat or shell for HM/Knoll/Fritz Hansen/Cassina foil sticker or burn-stamp; for Eames Lounge specifically confirm a 5-prong rosewood/walnut/santos palisander base (knockoffs use 4-prong bases and plastic-veneer shells); for Aeron look for HM logo on the base, 'Aeron' stamp on the lumbar yoke, PostureFit SL adjuster (Remastered only), and 8Z Pellicle mesh pattern; for Bertoia and Emeco check the underside for stamped maker mark. Mesh-back styling plus curves alone is the most replicated office-chair detail; do not assume Aeron without one of those four tells. Knockoffs are mass-produced and common."
  ...
  STRUCTURAL DAMAGE: ONLY when damage is unambiguously visible in the photo, a snapped/missing leg, a clearly cracked or split frame, a torn-through seat with springs poking out, dark water staining/swelling/bubbling on a wood surface, visible mold, a drawer hanging off-track, or a clearly broken joint. For chairs and seating specifically, also flag: a broken or seized recliner mechanism (lever hanging loose, footrest stuck open or closed, electric motor disconnected, missing hand control); a failed gas-lift cylinder on an office chair (chair sits at one fixed height with the adjustment lever doing nothing, or the cylinder visibly leaks oil at the base); sagging or torn Pellicle/mesh seat or back on an Aeron-style or ergonomic office chair (mesh has lost tension, visible holes, pulled-through plastic frame); a snapped spindle, broken stretcher, or split back slat on a dining chair, rocker, or Windsor-style chair; a missing castor wheel or broken castor lock on an office chair; deep cat-scratched or pet-shredded upholstery with stuffing visibly exposed (distinct from light surface pulls or pilling, which are CONDITION NOTES per the exclusions list). Do NOT flag for normal patina, light surface wear, intact wicker/cane that simply looks vintage, or pieces that appear sound. When in doubt, do NOT flag, false damage warnings erode trust. → Flag: "Structural damage visible, verify the piece is sittable/usable; refinishing won't compensate if the bones are compromised."
...
- upcycle[]: exactly 3 short, specific ideas for transforming this item to increase resale value. Before writing, identify: (1) exact material and texture, (2) specific construction details like hardware, seams, collar, lining, silhouette, (3) the era or subculture it references, (4) what niche aesthetic or current resale trend it could tap into if transformed. Use those observations to write ideas that could ONLY apply to this exact item, not any other. Each idea names a specific technique AND the niche aesthetic it creates. CLOTHING BANNED techniques (apply when category is NOT "furniture"): bleach dye, tie-dye, cropping, patches, pins, buttons, generic embroidery, if you catch yourself writing one, think harder about what makes this item unique. BANNED aesthetic defaults (apply to ALL categories): do not use any of these unless the item is literally from that era/style and you can point to a specific visible detail that justifies it: cottagecore, floral, bohemian, coquette, fairy-tale, whimsical, romantic. If you catch yourself writing one of these aesthetics, delete it and think of something more specific to this item.
  FURNITURE upcycle (category = "furniture" only): the clothing BANNED list above does NOT apply. Allowed techniques, REFINISH: sand to natural, dark walnut stain, whitewash, limewash, cerusing, fuming, oil-rubbed (linseed/tung), shou sugi ban, ebonized oak, pickled oak, raw waxed white oak, color-drench (everything painted one bold shade including hardware), two-tone (top one color, base another), pigmented wax glaze. REUPHOLSTER: boucle, mohair, shearling, performance velvet, vintage kilim, vintage Persian rug remnant, vintage textile, vintage suzani, Beni Ourain rug remnant, leather, hide-on cowhide, channel-tufted boucle, knife-pleated heavyweight linen, leather with brass nailhead. PAINT FRAME: chalk paint, eggshell lacquer, automotive 2K lacquer, milk paint with hemp-oil rub-out, high-gloss color-drench. HARDWARE SWAP: vintage brass pulls, knurled brass, antique cup pulls, leather pulls, leather pull-strap, ceramic knobs, custom-cast, lucite, blackened forged iron, rope pulls, low-profile bar pulls, raw cast bronze. SURFACE / STRUCTURAL: fluted or reeded door fronts, cane-insert door panels, rattan inserts, smoked-glass top, marble or travertine slab top, leather-wrapped top, swap legs (tapered, hairpin, brass, raw turned), add casters, raise base on a riser. RECANE or RERUSH damaged seats with new natural fiber. REPURPOSE: dresser → bathroom vanity, dresser → media console (with cable cutouts), china cabinet → bar cabinet (bottle storage + glass rack), nightstand → planter stand, ladder → blanket rack, drawer → wall shelf, door → headboard, old door → console table (legs + brackets), suitcase → side table. LIGHTING sub-clause (only when piece reads as a table lamp / sconce / pendant): replace shade in linen or pleated paper, rewire base, restore raw brass with Brasso, color-block ceramic body, paper lantern conversion. ERA-SHIFT RECIPES (highest-leverage pattern, recognize the source era from the photo and propose the recipe): 80s oak → MCM-look (limewash + tapered legs + brass pulls); traditional dark wood → Japandi (strip + tung oil + low profile + linen); brown furniture → Scandi minimal (whitewash + leather pulls); particleboard IKEA → upgraded (fluted front + brass + 2K lacquer); beat-up MCM → restored authenticity (period-correct refinish + boucle or wool). Q2 2026 ACTIVE SPIKES: boucle reupholstery, limewash refinish, brass-and-cane revival, color-drench painting, fluted/reeded fronts, organic-modern (raw oak + travertine), Japandi, warm minimalism, art-deco revival, Memphis revival. FURNITURE BANNED aesthetic defaults (same rule as the clothing banned list, only allowed if the piece is literally that style AND a specific visible detail justifies it): generic farmhouse, shabby chic, country-rustic, distressed-shabby, "primitive", "boho beach". Each idea targets a different aesthetic.
...
async function runScanPipeline(photoUris: string[], promptSuffix = '', signal?: AbortSignal, priorResult?: ScanScenario, onTier?: (tier: AiTier) => void): Promise<ScanScenario> {
  ...
  const multiPhotoSuffix = images.length > 1
    ? `\n\nPHOTO INTERPRETATION, you are given ${images.length} photos. Photo 1 is the COVER, the AFTER, the piece the user is selling, the ONLY piece you describe in \`name\` and \`sub\`. The cover slot is AUTHORITATIVE for what the AFTER is, do NOT swap based on which photo "looks more finished". Any photo whose CONSTRUCTION matches the cover (same straps-or-strapless status, same neckline, same hem, same hardware, same lace/embellishment placement) is ALSO the AFTER, multi-angle of the same finished piece. Any photo with DIFFERENT construction is either another multi-angle or the BEFORE source garment, classify per the rules below; either way it does NOT contribute vocabulary to name or sub.
...
AFTER ORIENTATION, HARD RULE (when beforeAfterDetected = true): the AFTER is the piece shown in photo 1 (the cover). The cover slot is AUTHORITATIVE, the user staged photo 1 as the cover because it is the piece they are selling. Any additional photo whose CONSTRUCTION matches the cover (same garment shape, same neckline, same straps-or-strapless status, same hem treatment, same hardware, same lace/embellishment placement, same fabric drape) is ALSO part of the AFTER set, multi-angle of the same finished piece. Any photo showing a DIFFERENT garment construction that shares fabric identity with the cover is the BEFORE source.

Do NOT swap the AFTER and BEFORE based on which photo "looks more finished" or "more polished". The cover slot is authoritative. The user knows which piece they made and staged it as photo 1. If a later photo shows a more factory-polished garment (intact corset, structured boning, embellished waistband, sequin trim, original prom/cocktail silhouette) while the cover shows a hand-constructed piece (added straps grafted to a strapless source, lace bodice on a different base, raw chiffon drape, asymmetric hem, ruching/cinching not in the original design), the polished photo is the BEFORE source and the cover is the AFTER. The "more polished = newer = AFTER" intuition is INVERTED for thrift flips, hand construction inherently looks less factory-perfect than the factory source garment.

DESCRIPTION ISOLATION, HARD RULE (when beforeAfterDetected = true): the \`name\` and \`sub\` fields describe ONLY the construction shown in the cover photo (and any photo whose construction matches the cover). Anchor every descriptive word to the cover photo's construction. Features that appear ONLY in photos with DIFFERENT construction from the cover are BEFORE features and MUST be omitted from name and sub. If the cover shows a piece with STRAPS, the AFTER has straps regardless of what other photos show, do NOT call it "strapless". If the cover shows a piece with a LACE BODICE and chiffon draping, do NOT pull in embellished waistband, sequin trim, structured boning, or high-low hem from other photos. Failure example from a real scan: cover showed a lace-bodice spaghetti-strap chiffon mini, later photos showed a strapless prom-style mini with black embellished waistband and high-low hem, the description WRONGLY merged into "lace bodice, black and silver embellished waist band, high-low hem", because the embellished waistband and high-low hem are on the BEFORE source garment, not on the cover-shown AFTER. The BEFORE never contributes silhouette, hardware, hem, embellishment, or strap vocabulary to the listing.
...
FINAL DESCRIPTION CHECK, DO THIS BEFORE RETURNING (runs whenever there are multiple photos, regardless of beforeAfterDetected status):
Re-read your draft \`name\` and \`sub\`. Look ONLY at photo 1 (the cover). For each descriptive word you wrote, ask: "Can I point to this in photo 1?" If no, DELETE it.

Specific cross-checks (run all four, do not skip):
  1. STRAPS: does the cover show straps (spaghetti, thin, wide, halter, one-shoulder, racerback)? If YES, name MUST mention the strap type AND MUST NOT say "strapless" / "tube" / "bandeau". If NO, name MUST say "strapless".
  2. WAISTBAND: does the cover show a structured/decorative waistband (embellished, sequined, beaded, patterned, metallic, contrasting color, wide belt)? If NO, OMIT any "embellished / sequin / beaded / patterned / metallic waistband / belt" from sub.
  3. HEM: does the cover show a high-low hem (visibly shorter in front, longer in back)? If NO, OMIT "high-low" from name and sub. If the cover crops above the hem entirely, OMIT hem descriptors.
  4. BODICE / NECKLINE: anchor the bodice description (lace, embroidered, ruched, plain, sweetheart, V-neck, scoop, square, halter, corset, tank, illusion mesh) to what is visible in the cover, NOT to what is visible in non-cover photos.
...
Worked positive example: cover shows a mint-green dress with thin spaghetti straps, lace bodice with center buckle, chiffon front overlay, no visible waistband detail, hem cropped out of frame. Correct name: "Mint Green Lace-Bodice Spaghetti-Strap Chiffon Mini Dress". Correct sub: "Women's, mint green, lace bodice with center buckle, spaghetti straps, chiffon overlay, good condition." INCORRECT (real failure mode from prior scans): "Strapless High-Low Chiffon Dress" with sub "lace bodice, black and silver patterned waistband, high-low hem", because strapless contradicts the visible straps, and the waistband + high-low hem are from a BEFORE source photo and do NOT appear in the cover.`
  ...
  // Large-silhouette handmade dresses (kaftan, abaya, butterfly abaya, batwing/dolman
  // maxi, floor-length gown) floor at moderate-tier $55 even when the model classifies
  // SIMPLE on "plain stretchy knit" surface description. Slip and shift examples in the
  // HANDMADE DRESS EXCEPTION simple band assume ~1.5-2.5 yds of fabric; a kaftan is
  // ~4 yds with dramatic drape and 2-3x the labor floor. Cap tracks the prompt's tier
  // ceilings: moderate-band $140 by default, $160 with premium fabric (satin/silk),
  // $200 only when visible complex-construction tells (lined, boned, multi-panel) match.
  const isHandmadeLargeDress = parsed.category === 'dresses'
    && isCustomScan
    && HANDMADE_LARGE_DRESS_RX.test(exceptionalText)
    && !isHandmadeCoordSet;
  if (isHandmadeLargeDress) {
    const hasPremiumFabric = PREMIUM_DRESS_FABRIC_RX.test(exceptionalText);
    const hasComplexConstruction = COMPLEX_DRESS_CONSTRUCTION_RX.test(exceptionalText);
    const floor = 55;
    const cap = hasComplexConstruction ? 200 : (hasPremiumFabric ? 160 : 140);
    if (resaleLow < floor) {
      resaleLow = floor;
      if (resaleHigh < floor + 35) resaleHigh = floor + 35;
    }
    if (resaleHigh > cap) {
      const scale = cap / resaleHigh;
      resaleHigh = cap;
  ...
  const isAlteredDress = parsed.category === 'dresses' && isCustomScan && !isSkirtText && !isSwimText && !isHandmadeCoordSet && !isHandmadeLargeDress;
  if (isAlteredDress) {
    // Basic-woven-base reworks (plaid flannel, cotton, twill, chambray, linen) cap at
    // moderate ceiling $65, NOT the complex ceiling $140. Real Depop sold comps for
    // unknown-maker altered prom/party dresses cluster $40–$60; the complex tier is
    // reserved for premium fabric (silk, satin, velvet) or visible boned/lined
    // construction. Tightened from $80 → $65 after user comp-check, $75+ recommended
    // prices were systematically over-asking for hobbyist reworks.
    ...
    const cap = isExceptionalDenim ? 300 : (isBasicFabricBase ? 65 : 140);
    if (resaleHigh > cap) {
      const scale = cap / resaleHigh;
      resaleHigh = cap;
...
function buildUpcyclePrompt(itemName?: string, category?: string, sub?: string): string {
  ...
  if (isFurniture) {
    return `You are a furniture flipper known for refurbs that read as studied, not generic. Look at this piece and suggest 3 ways to transform it for resale.
${itemContext}
Before writing anything, answer these questions internally:
1. What is the wood species or substrate, and what condition is the original finish in (sound / stained / worn through / particleboard with veneer chipping)?
2. What construction details does it have, joinery, hardware, panel inserts, leg profile, door fronts, drawer fronts, glass, cane, upholstery?
3. What era or style does the piece reference, MCM, Danish modern, Hollywood Regency, 80s laminate, traditional / Queen Anne, postmodern, particleboard mass-market?
4. What current resale trend could this specific piece tap into if transformed?

Use those answers to generate 3 ideas that could ONLY apply to this exact piece, not to any other piece of furniture. Each idea should feel like it was written by someone who actually studied this specific photo, not someone brainstorming generic refurbs.
...
Allowed technique vocabulary:
- REFINISH: sand to natural, dark walnut stain, whitewash, limewash, cerusing, fuming, oil-rubbed (linseed/tung), shou sugi ban, ebonized oak, pickled oak, raw waxed white oak, color-drench (one bold shade including hardware), two-tone (top vs base), pigmented wax glaze.
- REUPHOLSTER: boucle, mohair, shearling, performance velvet, vintage kilim, vintage Persian rug remnant, vintage suzani, Beni Ourain rug remnant, leather, hide-on cowhide, channel-tufted boucle, knife-pleated heavyweight linen, leather with brass nailhead.
- PAINT FRAME: chalk paint, eggshell lacquer, automotive 2K lacquer, milk paint with hemp-oil rub-out, high-gloss color-drench.
- HARDWARE SWAP: vintage brass pulls, knurled brass, antique cup pulls, leather pulls, leather pull-strap, ceramic knobs, custom-cast, lucite, blackened forged iron, rope pulls, low-profile bar pulls, raw cast bronze.
- SURFACE / STRUCTURAL: fluted or reeded door fronts, cane-insert door panels, rattan inserts, smoked-glass top, marble or travertine slab top, leather-wrapped top, swap legs (tapered, hairpin, brass, raw turned), add casters, raise base on a riser.
- RECANE / RERUSH damaged seats with new natural fiber.
- REPURPOSE: dresser → bathroom vanity, dresser → media console (cable cutouts), china cabinet → bar cabinet (bottle storage + glass rack), nightstand → planter stand, ladder → blanket rack, drawer → wall shelf, door → headboard, old door → console table, suitcase → side table.
- LIGHTING (only when piece reads as table lamp / sconce / pendant): replace shade in linen or pleated paper, rewire base, restore raw brass with Brasso, color-block ceramic body, paper lantern conversion.
- ERA-SHIFT RECIPES (highest-leverage, recognize source era and propose recipe): 80s oak → MCM-look (limewash + tapered legs + brass pulls); traditional dark wood → Japandi (strip + tung oil + low profile + linen); brown furniture → Scandi minimal (whitewash + leather pulls); particleboard IKEA → upgraded (fluted front + brass + 2K lacquer); beat-up MCM → restored authenticity (period-correct refinish + boucle or wool).

Q2 2026 ACTIVE SPIKES (match technique to one when the piece supports it): boucle reupholstery, limewash refinish, brass-and-cane revival, color-drench painting, fluted/reeded fronts, organic-modern (raw oak + travertine), Japandi, warm minimalism, art-deco revival, Memphis revival.

Rules:
- Each idea names a specific technique AND the niche aesthetic or trend it creates
- BANNED aesthetic defaults, do not use any of these unless the piece is literally that style and you can point to a specific visible detail that justifies it: generic farmhouse, shabby chic, country-rustic, distressed-shabby, "primitive", "boho beach", cottagecore. If you catch yourself writing one of these, delete it and think of something more specific to this piece
- Each of the 3 ideas must target a DIFFERENT aesthetic, never repeat the same aesthetic across the 3 ideas
