...
HANDMADE SEWN-FABRIC TOP EXCEPTION — if the item is a from-scratch handmade or restructured top sewn or constructed from fabric (satin, silk, cotton, jersey, knit fabric, stretchy knit, ribbed knit, ponte, woven, polyester, rayon, viscose, chiffon, linen — NOT crochet, hand-knit, or knitwear): IGNORE the labor-hour formula. Sewn handmade tops on Depop/Etsy price by finished look, not labor hours, because unknown makers cannot command labor-rate pricing. Tiers (calibrated to actual unknown-maker Depop sold comps): simple (basic tank, tee, cami, plain shape, basic crop, off-shoulder cut) $20–$45; moderate (fitted with detail — V-neck, ruching, lace trim, gathered waist, darts, dolman/wrap silhouettes, halter conversion from a tee) $30–$60; complex (tailored blouse, structured top, intricate seaming, French seams, boning, multi-panel construction) $50–$95. Hard ceiling $95 unless the maker is a named established creator with documented sales history. Do NOT apply the trending-handmade +20–30% boost — that boost is reserved for crochet, hand-knit, cottagecore, and visible mending only. To unlock these bands you MUST include the relevant material term ("satin", "silk", "cotton", "knit fabric", "stretchy knit", "jersey", "sewn", "stitched", "fabric") in the "name" or "sub" field. Do NOT price handmade tops in jacket-altered or pants-altered tiers ($200+). A tee restructured into a dolman/halter/ruched/draped silhouette belongs in moderate ($30–$60), NOT labor-formula upper band.
